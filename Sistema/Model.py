...
class AccessLog(Base):
    ...
    ambiente_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ambiente_nome: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    usuario_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    usuario_nome: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
...
_add_column_if_missing('access_logs', 'event_type', 'VARCHAR(50)')
_add_column_if_missing('access_logs', 'result', 'VARCHAR(20)')
_add_column_if_missing('access_logs', 'ambiente_id', 'INTEGER')
