...
def mqtt_connect():
    ...
    if MQTT_TLS:
        ...
        # 1883. gc.collect() logo abaixo maximiza a memória contígua
        # livre no momento exato do handshake.
        try:
...
def main():
    global DEVICE_MAC, BOOT_COUNT, ACCESSNG_VERSAO, _update_requested
